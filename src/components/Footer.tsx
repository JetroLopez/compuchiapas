      ...
      <div className="container-padding max-w-7xl mx-auto py-12 md:py-16">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="text-center text-gray-400">
            <p className="mb-4">© {new Date().getFullYear()} Compuchiapas. Todos los derechos reservados.</p>
            <div className="flex justify-center space-x-4 text-sm">
              <Link to="/policies#privacidad" className="hover:text-white transition-colors">
                Política de Privacidad
              </Link>
              <span>•</span>
              <Link to="/policies#terminos" className="hover:text-white transition-colors">
                Términos y Condiciones
              </Link>
              <span>•</span>
              <Link to="/policies#envios" className="hover:text-white transition-colors">
                Envíos
              </Link>
              <span>•</span>
              <Link to="/policies#devoluciones" className="hover:text-white transition-colors">
                Devoluciones
              </Link>
            </div>
          </div>
