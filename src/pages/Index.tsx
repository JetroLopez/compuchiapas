...
const Index: React.FC = () => {
  ...
  const testimonials = [
    {
      name: "Aaron López B.",
      testimonial: "Me encanta ir porque siempre encuentro lo que busco por más mínimo que sea, precios bastante accesible y a veces alguna que otra cosa más barata que las que puedo encontrar en Amazon. Si voy a armar una pc este es el lugar perfecto para ir ya que además de contar con todos los implementos necesarios siempre me atienden con amabilidad.",
      rating: 5,
      date: "hace 5 años"
    },
    {
      name: "Williams Martínez",
      testimonial: "Excelente servicio de ventas de Componentes, personal profesional.",
      rating: 5,
      date: "hace 1 año"
    },
    {
      name: "Alejandro Orbegozo",
      testimonial: "Excelente atención y asesoría en cuanto programas y repuestos.",
      rating: 5,
      date: "hace 2 meses"
    }
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase
        ...
        .insert([{
          name: formData.name,
          email: '',  // No tenemos campo de email en este formulario
          phone: formData.phone,
          subject: `Consulta sobre ${formData.device}`,
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        ...
                        6a. Avenida Sur, Los Naranjos, Centro, 30700 Tapachula de Córdova y Ordóñez, Chis.
                        </a>
                      </p>
                    </div>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <label htmlFor="privacy" className="ml-2 block text-sm text-gray-700">
                      Acepto la <Link to="/policies#privacidad" className="text-tech-blue hover:underline">política de privacidad</Link>
                    </label>
                  </div>
