        ...
        <div className="container-padding max-w-7xl mx-auto text-center my-[29px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            ...
            <div className="glass-card rounded-2xl p-8 text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <a 
                href="tel:9622148546" 
                className="bg-tech-blue hover:bg-tech-blue/90 text-white rounded-lg font-medium transition-all duration-300 inline-flex items-center justify-center gap-2 px-6 py-3 w-full"
              >
                <Phone size={18} />
                Llamar
              </a>
            ...
            <div className="glass-card rounded-2xl p-8 text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <a 
                ...
                className="bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg font-medium transition-all duration-300 inline-flex items-center justify-center gap-2 px-6 py-3 w-full"
              >
                <Mail size={18} />
                Enviar email
              </a>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="glass-card rounded-2xl overflow-hidden h-[400px] lg:h-auto">
              <div className="relative w-full h-full bg-gray-200">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3844.8901344674365!2d-92.26748792393895!3d14.901862085935325!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x858e0f6c0b733c69%3A0x33b3b47bc6717a36!2s6a%20Avenida%20Sur%2C%20Los%20Naranjos%2C%20Centro%2C%2030700%20Tapachula%20de%20C%C3%B3rdova%20y%20Ord%C3%B3%C3%B1ez%2C%20Chis.!5e0!3m2!1ses!2smx!4v1709944116099!5m2!1ses!2smx" 
                  width="100%" 
                  height="100%" 
                  style={{border: 0}} 
                ...
                <div className="absolute top-0 left-0 w-full h-full bg-black/5 flex items-center justify-center">
                  <div className="bg-white p-4 rounded-lg shadow-lg max-w-xs">
                    ...
                    <div className="flex items-center text-gray-700">
                      ...
                      <p className="text-sm">Lun-Sáb: 9am a 8pm</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    <span className="text-gray-600">90:00 AM - 2:00 PM</span>
                  </li>
                  <li className="flex justify-between items-center pb-2 border-b border-gray-200">
                ...
                <div className="mt-4 p-4 bg-tech-blue/10 rounded-lg">
                  ...
                  <a href="tel: 962 414 2417" className="mt-2 text-tech-blue font-medium hover:underline flex items-center">
